...
export const SetCity = () => {
  ...
  return (
    <div>
      ...
      >
        <MapPinnedIcon color="black" />
        <div className="flex items-center justify-center w-4 h-4 border rounded shadow text-[#000]">
          L
        </div>
      </button>
        ...
        <div className="grid grid-cols-3 gap-4 ">
          {cities.map((city) => (
            <button
              ...
              className="p-3 rounded hover:shadow-2xl transition-shadow"
              key={city.id}
            >
