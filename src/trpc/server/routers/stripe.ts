  ...
  checkout: protectedProcedure()
    ...
    .mutation(async ({ ctx, input: { sessionId } }) => {
      ...
      if (parsedBookingInfo.success) {
        ...
        const movieName = ticket.Bookings[0].Showtime.Movie.title
        ...
        const ticketQRCode = await BwipJs.toBuffer({
        ...
        const qrCode = await firebaseUpload(ticketQRCode, userId, ticket.id)
